...
apt-get -y install wget git unzip libevent-dev libboost-dev
apt-get -y install libboost-chrono-dev ibboost-filesystem-dev libboost-program-options-dev libboost-system-dev libboost-test-dev
apt-get -y install libboost-thread-dev libminiupnpc-dev
